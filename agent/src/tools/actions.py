...
def create_action_tools(
    ...
    def maintain_drill() -> str:
        ...
        Ice mining runs AUTOMATICALLY every sol (costs 800 Wh, yields 5-15L
        based on drill health). The drill degrades 5% per sol from auto-mining.
        Call this when drill_health_pct < 55% to prevent it falling below the
        10% failure threshold. Takes 6 hours of downtime.
