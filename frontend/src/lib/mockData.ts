...
export const mockCrops: T.CropBatch[] = [
  // Zone A — 4 beds
  {
    ...
    health_pct: 92,
    stress_water: 0.1,
    stress_nutrient: 0.05,
    stress_light: 0,
    stress_temp: 0.02,
    days_to_harvest: 28,
    yield_estimate_kg: 18.5,
    area_m2: 9,
  },
  {
    crop_id: "a2",
    ...
    health_pct: 95,
    stress_water: 0.02,
    stress_nutrient: 0.03,
    stress_light: 0,
    stress_temp: 0,
    days_to_harvest: 8,
    yield_estimate_kg: 4.8,
    area_m2: 12,
  },
  {
    crop_id: "a3",
  ...
  },
  {
    ...
    health_pct: 86,
    stress_water: 0.12,
    stress_nutrient: 0.08,
    stress_light: 0.03,
    stress_temp: 0.05,
    days_to_harvest: 22,
    yield_estimate_kg: 3.1,
    area_m2: 4,
  },
  // Zone B — 4 beds
  {
  ...
  },
  {
    ...
    health_pct: 45,
    stress_water: 0.2,
    stress_nutrient: 0.15,
    stress_light: 0.1,
    stress_temp: 0.05,
    days_to_harvest: 35,
    yield_estimate_kg: 2.1,
    area_m2: 8,
  },
  {
    crop_id: "b3",
  ...
  // Zone C — 4 beds
  {
    ...
    health_pct: 96,
    stress_water: 0.05,
    stress_nutrient: 0.02,
    stress_light: 0,
    stress_temp: 0,
    days_to_harvest: 5,
    yield_estimate_kg: 22.0,
    area_m2: 9,
  },
  {
    crop_id: "c2",
